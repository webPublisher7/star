...
<ul>
	...
	<li class="util_nav04"><a href="/store/store_map.do">Find a Store</a></li>
		...
		<!-- 서브 gnb end -->
					...
					<div class="product_kind_wrap">
						...
						<div class="product_toggle_wrap">
							<dl class="product_kind_tab">
								...
								<dd>
									<ul class="service_bn">
										<li><a href="javascript:void(0)" role="button"><img src="https://image.istarbucks.co.kr/upload/common/img/menu/bnr_20_summer1.jpg" alt="STAY CHILL. STAY PLAYFUL." data-sbseq="W0000333"></a></li>
									</ul>
								</dd>
							</dl>
						</div>
			...
			<script src="//image.istarbucks.co.kr/common/js/common.js"></script>
			<script src="/common/js/gnb.js?v=200218"></script>
			<script src="/common/js/header.js?v=200211"></script>
